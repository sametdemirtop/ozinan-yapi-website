        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <a
              ...
              className="hidden xl:flex items-center gap-2 bg-[#25D366] text-white px-4 py-2 rounded-lg hover:bg-[#128C7E] transition-colors font-medium text-sm shadow-md hover:shadow-lg"
            >
