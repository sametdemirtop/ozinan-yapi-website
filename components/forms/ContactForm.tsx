...
export default function ContactForm({ embedded = false }: ContactFormProps) {
  ...
  const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
    ...
    const serviceTranslation = t(`services.${formData.service}`);
    const whatsappMessage = `
Merhaba, web sitenizden ulaşıyorum.

*Ad Soyad:* ${formData.name}
*Telefon:* ${formData.phone}
*Hizmet Türü:* ${serviceTranslation}
...
Lütfen benimle en kısa sürede iletişime geçin.
    ...
    const whatsappUrl = `https://wa.me/905324533802?text=${encodedMessage}`;
        ...
        >
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent transition-all bg-white"
            >
          ...
          <button
            type="submit"
            className="w-full bg-[#0F766E] text-white font-bold py-4 px-6 rounded-lg hover:bg-[#075E54] transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-3"
          >
